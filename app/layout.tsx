  ...
  return (
    <html lang="en">
      <body className="font-sans antialiased">
        ...
        <div className="mx-auto min-h-screen w-full max-w-7xl px-4 py-5 md:px-8">
          <header className="app-header relative z-30 mb-4 flex items-center">
            <SkylarkBrand compact />
          </header>
          <div className="header-divider relative z-20 mb-6" aria-hidden />
